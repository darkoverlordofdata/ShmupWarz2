/* sdx.vapi generated by valac 0.34.4, do not modify. */

namespace sdxConstants {
...
namespace sdx {
	...
	public class Sdx : GLib.Object {
		public Sdx (sdx.Application app, int width, int height, string @base);
		public static sdx.Application app { get; }
